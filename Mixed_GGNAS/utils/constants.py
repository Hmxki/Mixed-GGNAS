...
#: Target masks shape - (N, H, W), model output masks shape (N, 1, H, W).
...
#: Target masks shape - (N, H, W), model output masks shape (N, C, H, W).
...
#: Target masks shape - (N, C, H, W), model output masks shape (N, C, H, W).
