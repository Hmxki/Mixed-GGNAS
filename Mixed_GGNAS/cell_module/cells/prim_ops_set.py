...
from Mixed_GGNAS.cell_module.cells.utils import *
...
OPS = {
    ...
    'up_cweight': lambda c, stride, affine, dp: CWeightOp(c, c, stride=2, affine=affine,use_transpose=True, dropout_rate=dp,output_padding=1),
...
class ConvOps(BaseOp):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1,dilation=1,groups=1,
                 bias=False, has_shuffle=False, use_transpose=False, output_padding=1, use_depthwise=False,
