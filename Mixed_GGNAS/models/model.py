...
from Mixed_GGNAS.cell_module.encoder_cell import EncoderCell
from Mixed_GGNAS.cell_module.decoder_cell import DecoderCell
from Mixed_GGNAS.cell_module.ops import OPS as ops_dict
...
class Model(nn.Module):
    ...
    def evaluate(self, train_loader, val_loader, loss_fn, metric_fn, device):
        ...
        try:
            ...
            # scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.5,patience=30, mode='min', min_lr=1e-07)
            ...
            for epoch in range(120):
                ...
                if early_stopping.stopTraining(epoch, avg_val_loss, avg_val_score, avg_tr_score):
        ...
        with open(f"results/model_{self.solNo}.txt", "w") as f:
            f.write(log)
